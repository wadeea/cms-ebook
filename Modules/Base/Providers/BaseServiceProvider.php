...
class BaseServiceProvider extends ServiceProvider
{
    ...
    protected $middleware = [
        ...
        'licensed' => \App\Http\Middleware\LicenseChecker::class,
    ...
    /**
     * Setup application Captcha config.
     *
     * @return void
     */
    private function setupCaptchaConfig()
    {
      
         $this->app['config']->set('captcha.siteKey', setting('invisible_captcha_site_key'));
         $this->app['config']->set('captcha.secretKey', setting('invisible_captcha_secret_Key'));
