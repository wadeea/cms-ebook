...
(function () {
    ...
    CI.langs['admin::admin.dummy.confirmation'] = '{{ clean(trans('admin::admin.dummy.confirmation')) }}';
    CI.langs['admin::admin.dummy.confirmation_message'] = '{{ clean(trans('admin::admin.dummy.confirmation_message')) }}';
    CI.langs['admin::admin.dummy.btn_import'] = '{{ clean(trans('admin::admin.dummy.btn_import')) }}';
    CI.langs['admin::admin.dummy.btn_cancel'] = '{{ clean(trans('admin::admin.dummy.btn_cancel')) }}';
    CI.langs['admin::admin.dummy.success_message'] = '{{ clean(trans('admin::admin.dummy.success_message')) }}';
