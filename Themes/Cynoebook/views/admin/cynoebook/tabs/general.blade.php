...
{{ Form::checkbox('cynoebook_Categories_menu_dropdown_enabled', clean(trans('cynoebook::attributes.cynoebook_Category_dropdown')), clean(trans('cynoebook::cynoebook.form.enable_Categories_menu_dropdown')), $errors, $settings) }} 
