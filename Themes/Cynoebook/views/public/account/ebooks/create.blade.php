    ...
    <section class="ebook-list">
        ...
        <div class="account-details">
            ...
            <div class="account clearfix">
				@if($daily_limit_over)
					<div class="alert alert-danger">{{clean(trans('cynoebook::ebook.the_daily_limit_of_uploading_ebooks_has_been_exceeded'))}}</div>
				@endif
                        ...
                        <div class="form-inner clearfix">
                            ...
                            <div class="col-md-12 col-sm-12">
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    {{ Form::text('key_word', clean(trans('ebook::attributes.key_word')), $errors, '', ['labelCol'=>12]) }}
                                    
                                    {{ Form::text('target_reader', clean(trans('ebook::attributes.target_reader')), $errors, '', ['labelCol'=>12]) }}
                                    ...
                                    {{ Form::text('book_edition', clean(trans('cynoebook::ebook.book_edition')), $errors, '', ['labelCol'=>12]) }} 
                                ...
                                <div class="col-md-6 col-sm-12">
                                    ...
                                    {{ Form::text('country_origin', clean(trans('cynoebook::ebook.country_origin')), $errors, '', ['labelCol'=>12]) }}
                                    
                                    {{ Form::text('book_language', clean(trans('cynoebook::ebook.book_language')), $errors, '', ['labelCol'=>12]) }}
                                    
                                    {{ Form::text('number_of_pages', clean(trans('cynoebook::ebook.number_of_pages')), $errors, '', ['labelCol'=>12]) }}
